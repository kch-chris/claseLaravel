...
<head>
    ...
    {{-- <link href="{{ asset('css/app.css') }}" rel="stylesheet"> --}}
     ...
     <!-- Custom CSS -->
     <link href="{{ asset('assets/adminmart/css/style.css') }} " rel="stylesheet">
...
<body>
    ...
    <!-- apps -->
    <!-- apps -->
    <script src="{{ asset('assets/adminmart/js/app-style-switcher.js') }}"></script>
    <script src="{{ asset('assets/adminmart/js/feather.min.js') }}"></script>
    <script src="{{ asset('assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js') }}"></script>
    <script src="{{ asset('assets/adminmart/js/sidebarmenu.js') }}"></script>
    <!--Custom JavaScript -->
    <script src="{{ asset('assets/adminmart/js/custom.min.js') }} "></script>
